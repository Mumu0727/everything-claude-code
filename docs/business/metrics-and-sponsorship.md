...
```bash
gh api repos/Mumu0727/everything-claude-code \
...
```bash
gh api repos/Mumu0727/everything-claude-code/traffic/views
gh api repos/Mumu0727/everything-claude-code/traffic/clones
```
